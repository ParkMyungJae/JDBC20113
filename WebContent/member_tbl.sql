...
DELETE FROM MEMBER_TBL WHERE MEMNO = 1005; --회원번호가 1005번인 레코드를 제거하시오.
--지정된 MEMNO값에 해당하는 칼럼 값을 수정하기
...
COMMIT
INSERT INTO MEMBER_TBL VALUES(1001,'홍길동', 'HONG1', '1234', 2002, '남자', '학생', '서울',now());
INSERT INTO MEMBER_TBL VALUES(1002,'고길동', 'HONG2', '1234', 2010, '여자', '교사', '성남',now());
INSERT INTO MEMBER_TBL VALUES(1003,'강길동', 'HONG3', '1234', 2009, '남자', '학생', '용인',now());
INSERT INTO MEMBER_TBL VALUES(1004,'장길동', 'HONG4', '1234', 2008, '여자', '가수', '수원',now());
